...
| BL-13.4.0 | VALIDATED CONTROL | Four frozen 4-input max-plus predicate controls are deterministic, nonconstant and exactly distinct; degrees are 3–4 and nonlinearities 2–3. None is balanced and no novelty or advantage is claimed; BL-13.4.1 remains proposed. |
